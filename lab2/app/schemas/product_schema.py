...
class ProductCreate(BaseModel):
    ...
    description: str | None = Field(None, max_length=1000, description="Описание продукта")
...
class ProductUpdate(BaseModel):
    ...
    name: str | None = Field(None, min_length=1, max_length=200, description="Название продукта")
    description: str | None = Field(None, max_length=1000, description="Описание продукта")
    price: float | None = Field(None, gt=0, description="Цена продукта")
    stock_quantity: int | None = Field(None, ge=0, description="Количество товара на складе")
...
class ProductListResponse(BaseModel):
    ...
    total: int = Field(..., ge=0, description="Общее количество продуктов в базе данных")
